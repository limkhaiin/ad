...
def detect_anamoly_original_token(dataset, best_probability, y_test): 
    result=[] 
    word_probability=[] 
...
def detect_anamoly_frequency_token(dataset, corpus, y_test, best_probability): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
def detect_anamoly_cosine_token(dataset, best_probability, cosine_threshold, k, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
def detect_anamoly_position_token(dataset, best_probability, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
