# -*- coding: utf-8 -*-
"""GPT_2_sentence_level.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Xcz9EYTTiVbG-ZiVRE8LdnJJoprjpwGV
"""
...
def detect_anamoly_sentence_frequency(dataset, corpus, y_test, best_probability): 
    result=[] 
    word_probability=[] 
...
def detect_anamoly_sentence_basic(dataset, best_probability, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
def detect_anamoly_sentence_cosine(dataset, best_probability, cosine_threshold, k, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
def detect_anamoly_sentence_position(dataset, best_probability, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
def detect_anamoly_sentence_position_threshold(dataset, best_probability, y_test): 
    result=[] 
    word_probability=[] 
    model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
